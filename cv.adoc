...
image:./assets/certifications/UC-FE36ZNL4.jpg["Hibernate certificate", width=128, link="./certifications/UC-FE36ZNL4.jpg"]
|===
...
image:./assets/certifications/MongoCertification.png["MongoDb for Java Developers", width=128, link="./certifications/MongoCertification.png"]
|===
...
image:./assets/certifications/FPPinScalaCertification.png["Functional programming principles", width=128, link="./certifications/FPPinScalaCertification.png"]
|===
